...
function FeatureCard({
  ...
  return (
    <div
      className={`group glass-card !p-3 hover-lift cursor-default animation-delay-${delay}`}
      style={{ animationDelay: `${delay}ms` }}
    >
      <div className="flex items-center gap-3">
        <div className="relative shrink-0">
          <div className="absolute inset-0 rounded-lg bg-gradient-to-br from-[#a0592b] to-[#f26522] opacity-20 blur-lg group-hover:opacity-40 transition-opacity" />
          <div className="relative flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-[#a0592b] to-[#f26522] text-white shadow-lg">
...
export function AuthLayout() {
  ...
  return (
    <div className="fixed inset-0 flex overflow-hidden" dir={language === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <div className="relative flex w-full flex-col justify-center px-4 lg:w-1/2 lg:px-12 z-10">
        {/* Logo - Mobile */}
        ...
        <div className="mx-auto w-full max-w-md">
          <div className="glass-card !p-5 shine">
            <Outlet />
          </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 lg:flex-col lg:justify-center lg:px-8 xl:px-12 relative z-10">
        {/* Content */}
        <div className="max-w-lg mx-auto">
          ...
          <div className="mb-6 animate-fade-in">
            <Link to="/" className="inline-flex items-center gap-3 group">
              <div className="relative">
                <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-[#a0592b] to-[#f26522] blur-xl opacity-50 group-hover:opacity-70 transition-opacity" />
                <div className="relative flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-[#a0592b] to-[#f26522] shadow-xl">
                  <Building2 className="h-7 w-7 text-white" />
                </div>
              </div>
              <div>
                <h1 className="text-2xl font-bold text-theme-primary text-shadow">{t('branding.hbrc')}</h1>
              </div>
            </Link>
          </div>
          ...
          <div className="mb-6 animate-fade-in animation-delay-200">
            <h2 className="text-2xl xl:text-3xl font-bold text-theme-primary leading-tight mb-2 text-shadow-lg">
              {t('branding.tagline')}
          ...
          {/* Features - Compact */}
          <div className="grid gap-2 animate-fade-in animation-delay-300">
            <FeatureCard
              icon={Shield}
          ...
          {/* Stats */}
          <div className="mt-6 flex items-center gap-4 animate-fade-in animation-delay-700">
            <div className="glass-card-dark !p-3 text-center flex-1">
              <div className="text-lg font-bold text-[#d4a84b]">99.9%</div>
              <div className="text-[10px] text-theme-muted">{t('stats.uptime')}</div>
            </div>
            <div className="glass-card-dark !p-3 text-center flex-1">
              <div className="text-lg font-bold text-[#f26522]">+1000</div>
              <div className="text-[10px] text-theme-muted">{t('stats.activeClients')}</div>
            </div>
            <div className="glass-card-dark !p-3 text-center flex-1">
              <div className="text-lg font-bold text-[#a0592b]">24/7</div>
              <div className="text-[10px] text-theme-muted">{t('stats.support')}</div>
            </div>
          </div>

          {/* Badge */}
          <div className="mt-4 inline-flex items-center gap-2 glass-card-dark !p-2 !px-3 animate-fade-in animation-delay-1000">
            <Award className="h-3 w-3 text-[#d4a84b]" />
            <span className="text-xs text-theme-secondary">{t('branding.certified')}</span>
          </div>
        </div>
      </div>
    </div>
